...
localhost=$(hostname)
fecha=$(date +%y-%m-%d)
BACKUP_COBISHOME="/cobishome/backups_cobis7srva_CTS_1/"
BACKUP_COBISHOME2="/cobismthome/backups_cobis7srva_CTS_2/"
LOGS_COBISHOME="/cobishome/backups_cobis7srva_CTS_1/cobishome_${localhost}_backup.log"
LOGS_COBISHOME2="/cobismthome/backups_cobis7srva_CTS_2/cobismthome_${localhost}_backup.log"
# Ruta de la carpeta cobishome
COBISHOME_PATH="/cobishome/"
COBISHOME_PATH2="/cobismthome/"
...
echo "Generando tar de /cobismthome"
cd $COBISHOME_PATH2;
tar -cvf $BACKUP_COBISHOME2/cobismthome_"$localhost"_$fecha.tar -X excluirbackups.txt . 

echo "Comprimiendo tar"
gzip -9 $BACKUP_COBISHOME2/cobismthome_"$localhost"_$fecha.tar
