...
QMANAGER2="QM.COBISMT"
DESTINO_BACKUP="/cobishome/backups_cobis7srva_CTS_1"
DESTINO_BACKUP2="/cobismthome/backups_cobis7srva_CTS_2"
LOGS_PROFILE="/cobishome/backups_cobis7srva_CTS_1/QM.COBISTS_${localhost}_backup.log"
LOGS_PROFILE2="/cobismthome/backups_cobis7srva_CTS_2/QM.COBISMT_${localhost}_backup.log"
...
echo "Generando Backup QM.COBISMT " 
dmpmqcfg -m "$QMANAGER2" -a > "$DESTINO_BACKUP2/QM.COBISMT_$fecha.mqsc" 
