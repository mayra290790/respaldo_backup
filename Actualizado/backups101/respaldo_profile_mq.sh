...
DESTINO_BACKUP="/cobishome/backups_cobissrv4_CTS_1"
DESTINO_BACKUP2="/cobishomeINT/backups_cobissrv4_CTS_2"
LOGS_PROFILE="/cobishome/backups_cobissrv4_CTS_1/QM.COBISTS_${localhost}_backup.log"
LOGS_PROFILE2="/cobishomeINT/backups_cobissrv4_CTS_2/QM.COBISINT_${localhost}_backup.log"
