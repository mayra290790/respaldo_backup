...
# Variables
localhost=$(hostname)
BACKUP_COBISHOME="/cobishome/backups_P690_CTS_1/"
BACKUP_COBISHOME2="/cobishome2/backups_P690_CTS_2/"
LOGS_COBISHOME="/cobishome/backups_P690_CTS_1/cobishome_${localhost}_backup.log"
LOGS_COBISHOME2="/cobishome2/backups_P690_CTS_2/cobishome2_${localhost}_backup.log"
# Ruta de la carpeta cobishome
COBISHOME_PATH="/cobishome/"
COBISHOME_PATH2="/cobishome2/"
...
echo "Generando tar de cobishome2"
cd $COBISHOME_PATH2;
tar -cvf $BACKUP_COBISHOME2/cobishome2_"$localhost"_$fecha.tar -X excluirbackups.txt . 

echo "Comprimiendo tar"
gzip $BACKUP_COBISHOME2/cobishome2_"$localhost"_$fecha.tar
